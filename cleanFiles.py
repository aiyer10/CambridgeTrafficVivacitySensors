...
locations = pd.read_csv(r'C:\Users\IyerA3\OneDrive - Vodafone Group\Personal\CambridgeshireTraffic-main\CambridgeSmartSensors\Locations.csv')
# print(locations.head())

d = pd.DataFrame()
for f in glob.glob(os.path.join(r'C:\Users\IyerA3\OneDrive - Vodafone Group\Personal\CambridgeshireTraffic-main\CambridgeSmartSensors', 'S*.csv')):
	print(f.split('\\')[-1])
...
d.to_parquet(r'C:\Users\IyerA3\OneDrive - Vodafone Group\Personal\CambridgeshireTraffic-main\CambridgeSmartSensors\SensorData.parquet', index=None, engine='fastparquet')
